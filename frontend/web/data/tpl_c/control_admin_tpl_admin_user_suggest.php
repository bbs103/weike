<?php keke_tpl_class::checkrefresh('control/admin/tpl/admin_user_suggest', '1418096907' );?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<?php if(is_array($suggestlist_arr)) { foreach($suggestlist_arr as $k => $v) { ?>
        <tr class="item">
        	<td class="td25"><input type="checkbox" name="ckb[]" class="checkbox" value="<?php echo $v['p_id'];?>"><?php echo $v['p_id'];?></td>
