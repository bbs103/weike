...
<script type="text/javascript" src="resource/js/system/keke.js"></script>
 ...
 <div class="page_title">
    	<h1>文章管理</h1>
         <div class="tool">
            <a href="index.php?r=article/web_affiche" >网站公告列表</a>
            <a href="index.php?r=article/add_affiche"  class="here">网站公告添加</a>
    	</div>
</div>
<!--页头结束-->    
...
if(json.status==1){ 
 ...
 $("#hdn_art_pic").val("");
                      ...
                      <tr>
                        ...
                        <td>
                         <textarea rows="30" name="fields[content]" style="width:75%;" id="tar_content"  class="xheditor {urlBase:'http://www.weike.com/wkxt/',tools:'simple',admin:'../../',html5Upload:false,emotMark:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=att'}" cols="70"></textarea>
</td>
 </tr>
                     <tr>
