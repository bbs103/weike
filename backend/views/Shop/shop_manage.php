...
<a href="index.php?do=store&view=list&txt_username=&txt_shop_id=&page=1&w[ord][0]=&w[ord][1]=&wh[page_size]=10&ac=close&shop_id=7" class="button"><span class="pen icon"></span>关闭</a>
</td>
          </tr>
         <tr class="item">
