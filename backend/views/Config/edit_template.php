...
<div class="page_title">
    	<h1>短信模板</h1>
  <div class="tool">         
    <a href="index.php?r=config/message_template"> 模板列表</a>
    <a href="index.php?r=config/edit_template"  class="here"  > 模板编辑</a>
  </div>
</div>
<div class="box post">
        <div class="tabcon">
            ...
            <tr>
                ...
                <td>
                    <div class="field" style="margin-left:-10px;*margin-left:0">
                        <textarea name="tar_msg_temp_content" id="system-create-location_1" id="tar_content" class="xheditor {tools:'Source',urlBase:'http://www.weike.com/wkxt',html5Upload:false,upImgUrl:'../../index.php?do=ajax&view=upload&file_type=editor'}" cols="70" style="width: 75%; display: none;" rows="15"></textarea>
                    </div>
                </td>
            </tr> 
            <tr>
