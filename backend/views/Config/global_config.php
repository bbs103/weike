...
<div class="page_title">
    	<h1>全局配置</h1>
         <div class="tool">         
            <a href="index.php?r=config/global_config" class="here" > 站点配置</a>
            <a href="index.php?r=config/basic_config"  >	基本配置</a>
<a href="index.php?r=config/seo_config"  >SEO配置</a>
<a href="index.php?r=config/email_config"  >邮箱配置</a>
    	</div>
</div>
...
<br/>&nbsp;&nbsp;网站名称并非网站标题,仅在页底显示及发送邮件等处使用 
                      ...
                      <tr>
                        ...
                        <td><input type="text" size="50" name="website_url"  value="http://www.weike.com/wkxt" maxlength="100" limit="required:true;len:3-100;general:false" msg="网站地址不正确，长度3-100" msgArea="web_url_msg" class="txt"/>
