...
<div class="page_title">
    	<h1>行业管理</h1>
        <div class="tool">
            <a href="index.php?r=config/industry_manage" class="here">行业列表</a>
            <a href="index.php?r=config/add_industry">添加行业</a> 
            <a href="index.php?r=config/industry_merge" >行业合并</a>
</div>
</div>
