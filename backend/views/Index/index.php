...
<script type="text/javascript" src="resource/js/lang.js" ></script>
</head>
...
<div class="header">
<div class="logo">
<h1><img src="resource/img/logo.png" alt="后台管理 - 客客专业威客系统" title="后台管理 - 客客专业威客系统"/></h1>
    </div>
...
$("#show_much").hide(); 
    ...
    <div class="user_box">
    	<div class="avatar">
        	<a href="#" title="admin"><img src='data/avatar/default/man_small.jpg' uid='1' class='pic_small'></a> </div>
   		...
   		<dl>
                  ...
                  <dd>
                        <ul id="ul_kjcz">
                        	                        		...
                        	                        		<li><a href="index.php?r=shortcut/auth_item" target="display_frame" class="select" r_id="38">认证项目</a></li>
                        		<li><a href="index.php?r=shortcut/auth_cache" target="display_frame"  r_id="20">更新缓存</a></li>
</ul>
                  </dd>
                </dl>
       </div>
   
          <div style="display: none;" id="config" class="menu_bar">
       	      		<dl>
                  	<dt><i class="arrow_b">&nbsp;</i>系统配置</dt>
                  <dd style="display: block;">
                        <ul>
                        	<li><a href="index.php?r=config/global_config" target="display_frame" r_id="34">全局配置</a></li>
<li><a href="index.php?r=config/task_model" target="display_frame" r_id="37">模型管理</a></li>
<li><a href="index.php?r=config/ucenter_integrate" target="display_frame" r_id="35">会员整合</a></li>
<li><a href="index.php?r=config/custom_nav" target="display_frame" r_id="41">自定义导航</a></li>
<li><a href="index.php?r=config/rate_config" target="display_frame" r_id="148">汇率配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=config/industry_manage" target="display_frame" r_id="7">行业管理</a></li>
<li><a href="index.php?r=config/skill_manage" target="display_frame" r_id="8">技能管理</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=config/oauth_login" target="display_frame" r_id="63">OAuth登录</a></li>
<li><a href="index.php?r=config/map_api" target="display_frame" r_id="141">地图接口</a></li>
<li><a href="index.php?r=config/message_config" target="display_frame" r_id="66">短信配置</a></li>
<li><a href="index.php?r=config/message_template" target="display_frame" r_id="73">短信模板</a></li>
<li><a href="index.php?r=config/pay_api" target="display_frame" r_id="2">支付接口</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=config/service_manage" target="display_frame" r_id="138">服务项管理</a></li>
<li><a href="index.php?r=config/buy_record" target="display_frame" r_id="139">购买记录</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
           <div style="display: none;" id="article" class="menu_bar">
       	      		<dl>
                  	<dt><i class="arrow_b">&nbsp;</i>关于网站</dt>
                  <dd style="display: block;">
                        <ul>
                        	<li><a href="index.php?r=article/web_affiche" target="display_frame" r_id="156">网站公告</a></li>
<li><a href="index.php?r=article/about_manage" target="display_frame" r_id="157">网站介绍</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=article/article_manage" target="display_frame" r_id="16">文章管理</a></li>
<li><a href="index.php?r=article/category_manage" target="display_frame" r_id="14">文章分类</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=article/help_category" target="display_frame" r_id="44">帮助分类</a></li>
<li><a href="index.php?r=article/help_manage" target="display_frame" r_id="42">帮助管理</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd style="display: none;">
                        <ul>
                        	<li><a href="index.php?r=article/case_manage" target="display_frame" r_id="154">案例管理</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
           <div id="task" class="menu_bar">
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=task/single_manage" target="display_frame" r_id="m10">任务管理</a></li>
<li><a href="index.php?r=task/basic_single" target="display_frame" r_id="m11">任务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=task/double_manage" target="display_frame" r_id="m22">任务管理</a></li>
<li><a href="index.php?r=task/basic_double" target="display_frame" r_id="m23">任务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=task/piece_manage" target="display_frame" r_id="m34">任务管理</a></li>
<li><a href="index.php?r=task/basic_piece" target="display_frame" r_id="m35">任务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=task/normal_manage" target="display_frame" r_id="m46">任务管理</a></li>
<li><a href="index.php?r=task/basic_normal"" target="display_frame" r_id="m47">任务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=task/subscript_manage" target="display_frame" r_id="m58">任务管理</a></li>
<li><a href="index.php?r=task/basic_subscript" target="display_frame" r_id="m59">任务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
           <div id="shop" class="menu_bar">
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=shop/shop_manage" target="display_frame" r_id="170">店铺管理</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=shop/order_opus" target="display_frame" r_id="m610">订单管理</a></li>
<li><a href="index.php?r=shop/opus_manage" target="display_frame" r_id="m611">作品管理</a></li>
<li><a href="index.php?r=shop/opus_config" target="display_frame" r_id="m612">作品配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=shop/order_service" target="display_frame" r_id="m713">订单管理</a></li>
<li><a href="index.php?r=shop/service_manage" target="display_frame" r_id="m714">服务管理</a></li>
<li><a href="index.php?r=shop/service_config" target="display_frame" r_id="m715">服务配置</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
           <div id="finance" class="menu_bar">
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=finance/finance_survey" target="display_frame" r_id="152">财务概况</a></li>
<li><a href="index.php?r=finance/finance_detail" target="display_frame" r_id="4">财务明细</a></li>
<li><a href="index.php?r=finance/finance_analyze" target="display_frame" r_id="3">财务分析</a></li>
<li><a href="index.php?r=finance/pay_audit" target="display_frame" r_id="76">充值审核</a></li>
<li><a href="index.php?r=finance/deposit_audit" target="display_frame" r_id="5">提现审核</a></li>
<li><a href="index.php?r=finance/manul_pay" target="display_frame" r_id="155">手动充值</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
           <div id="user" class="menu_bar">
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=finance/add_user" target="display_frame" r_id="10">添加用户</a></li>
<li><a href="index.php?r=finance/user_manage" target="display_frame" r_id="11">用户管理</a></li>
<li><a href="index.php?r=user/group_manage" target="display_frame" r_id="33">用户组</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=user/system_group" target="display_frame" r_id="13">系统组管理</a></li>
<li><a href="index.php?r=user/add_system" target="display_frame" r_id="12">添加系统组</a></li>
      		...
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=user/rule_manage" target="display_frame" r_id="36">信誉规则</a></li>
<li><a href="index.php?r=user/comment_config" target="display_frame" r_id="78">互评配置</a></li>
<li><a href="index.php?r=user/comment_record" target="display_frame" r_id="79">互评记录</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=user/deal_safeguard" target="display_frame" r_id="80">交易维权</a></li>
<li><a href="index.php?r=user/deal_inform" target="display_frame" r_id="81">交易举报</a></li>
<li><a href="index.php?r=user/complaint_suggest" target="display_frame" r_id="82">投诉建议</a></li>
 		                        </ul>
                  </dd>
                </dl>
      		<dl>
                  ...
                  <dd>
                        <ul >
                        	<li><a href="index.php?r=user/company_approve" target="display_frame" r_id="147">企业认证</a></li>
<li><a href="index.php?r=user/bank_approve" target="display_frame" r_id="68">银行认证</a></li>
<li><a href="index.php?r=user/autonym_approve" target="display_frame" r_id="70">实名认证</a></li>
<li><a href="index.php?r=user/email_approve" target="display_frame" r_id="71">邮箱认证</a></li>
<li><a href="index.php?r=user/mobile_approve" target="display_frame" r_id="77">手机认证</a></li>
<li><a href="index.php?r=user/approve_manage" target="display_frame" r_id="38">认证项目</a></li>
 		                        </ul>
                  </dd>
                </dl>
          </div>
...
<iframe id="display_frame" name="display_frame"  scrolling="auto"  src="" frameborder="0" ></iframe>
</div>
<script type="text/javascript">
/*add shortcuts*/  
