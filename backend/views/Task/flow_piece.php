...
<div class="page_title">
  <h1>计件悬赏任务配置</h1>
    <div class="tool">
      ...
      <a href="index.php?r=task/flow_piece" class="here">流程配置</a>
      <a href="index.php?r=task/access_piece">权限配置</a>
    </div>
</div>
<div class="box post">
<div class="tabcon">
...
<a href="javascript:;" id="add_delay_rule"><img src="resource/img/ico/add.gif" align="absmiddle" alt=''/>添加规则</a>
</td>
</tr>
<tr>
