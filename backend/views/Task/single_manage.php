...
<th width="10%">任务状态</th>
                    <th width="25%">处理</th>
                                    ...
                                    <tr class="item">
                 	<td class="td25"><input type="checkbox" name="ckb[]" class="checkbox" value="71" class="checkbox">71</td>
                    <td class="td28">
                    	<a href="../../index.php?do=task&task_id=71" target="_blank">aaaaaaaaaaaaa</a>
</td>
...
<a href="index.php?do=model&model_id=1&view=list&task_id=71&ac=recommend&page=1" onclick="return crecomm(this,'',1);" class="button"><span class="uparrow icon"></span>荐</a>
<a href="index.php?do=model&model_id=1&view=edit&task_id=71&page=1" class="button dbl_target"><span class="pen icon"></span>查看</a>
</td>
                  </tr>
                                    <tr class="item">
