...
<div class="page_title">
  <h1>订金招标任务配置</h1>
    <div class="tool">
    <a href="index.php?r=task/basic_subscript" class="here">基本配置</a>
      <a href="index.php?r=task/flow_subscript">流程配置</a>
      <a href="index.php?r=task/access_subscript" >权限配置</a>
     </div>
</div>
<div class="box post">
 <div class="tabcon">
