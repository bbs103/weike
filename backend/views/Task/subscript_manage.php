...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=63&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=51&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=42&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=38&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=36&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=29&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=26&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=20&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=19&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
                         <tr class="item">
...
<a href="index.php?do=model&model_id=5&view=list&ac=del&task_id=10&page=1" onclick="return cdel(this);" class="button"><span class="trash icon"></span>删除</a>
   		 </td>
                         </tr>
<tr>
                           <td colspan="7">
